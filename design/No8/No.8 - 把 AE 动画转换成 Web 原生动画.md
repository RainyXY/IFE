...
- 下载我们提供给你的设计稿以及 AE 源文件，通过 Lottie 导出 Web可用的 json 文件，实现预览demo 中所示首页动画效果
- 参考资料： Lottie 官方文档：[https://github.com/airbnb/lottie-web](https://github.com/airbnb/lottie-web)
- 预览demo： [http://vis.baidu.com/](http://vis.baidu.com/)
